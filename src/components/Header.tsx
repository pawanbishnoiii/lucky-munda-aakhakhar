    ...
    <header className="bg-card/95 backdrop-blur-xl sticky top-0 z-40 px-4 py-3 flex items-center justify-between border-b border-border/50">
      ...
      {user && (
        <div className="relative">
          ...
          {showNotifs && (
            <motion.div initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }} className="absolute right-0 top-12 w-72 bg-card rounded-xl p-3 z-50 max-h-60 overflow-y-auto space-y-2 border border-border/50 shadow-lg">
